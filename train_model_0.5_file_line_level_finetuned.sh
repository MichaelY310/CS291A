...
CUDA_VISIBLE_DEVICES=4,5,6,7 python3 -m verl.trainer.main_ppo \
   data.train_files='/home/yuanyang/CS291A/data/parquet/file_line_level/433-enriched_claude3-7_train.parquet' \
   data.val_files='/home/yuanyang/CS291A/data/parquet/file_line_level/433-enriched_claude3-7_val.parquet' \
   ...
   actor_rollout_ref.rollout.max_num_batched_tokens=78000 \
   ...
   trainer.experiment_name='qwen-0.5b__433-enriched_claude3-7__file_line_level__finetuned' \
