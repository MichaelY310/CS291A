...
export RAY_ADDRESS=127.0.0.1:6377

cd /home/yuanyang/CS291A/verl

ray stop
CUDA_VISIBLE_DEVICES=0,1 ray start --head --port=6377 --num-gpus=2
...
CUDA_VISIBLE_DEVICES=0,1 python3 -m verl.trainer.main_ppo \
   ...
   trainer.experiment_name='qwen-0.5b__433-enriched_claude3-7__file_level__finetuned' \
